...
const PaymentTypeList = ({fetchPaymentTypeDataFunc, paymentTypeList, isLoading}) => {
        ...
        },
        {
            ...
            validate: (rowData) =>
                rowData.code === undefined
                    ? {isValid: false, helperText: "Payment Type code is required"}
                    : rowData.code === ""
                        ? {isValid: false, helperText: "Payment Type code is required"}
                        : true,
            editable: "onAdd",
        },
        {
            ...
            validate: (rowData) =>
                rowData.type === undefined
                    ? {isValid: false, helperText: "Payment Type is required"}
                    : rowData.type === ""
                        ? {isValid: false, helperText: "Payment Type is required"}
                        : true,
        },
        {
            ...
            validate: (rowData) =>
                rowData.description === undefined
                    ? {
                        isValid: false,
                        helperText: "Payment Type description is required.",
                    }
                    : rowData.description === ""
                        ? {
                            isValid: false,
    ...
    const fetchTableData = (query) => {
        const tableData = paymentTypeService()
            .getAllByPagination(
                query.page + 1,
                query.pageSize,
                query.orderBy?.field,
            ...
            .then(({data}) => {
                var mappedData = data.paymentType.map(item => ({
                    id: item.id,
                    code: item.code,
                    type: item.type,
