...
const PayrollTakeHomeModal = ({show, setShow, takeHomeProcess, ...props}) => {
    ...
    return (
        <Fragment>
            <Modal size="lg" show={show} onHide={handleClose} centered {...props}>
                <div className="row">
                    <MaterialTable
                        title="Take Home"
                        icons={tableIcons}
                        columns={columns}
                        data={takeHomeProcess}
                        options={{
...
export default PayrollTakeHomeModal;
