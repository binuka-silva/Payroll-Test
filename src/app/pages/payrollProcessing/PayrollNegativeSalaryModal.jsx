...
const PayrollNegativeSalaryModal = ({show, setShow, negativeSalaryProcess, ...props}) => {
    ...
    return (
        <Fragment>
            <Modal size="lg" show={show} onHide={handleClose} {...props} scrollable={true}>
                <div className="row">
                    <MaterialTable
                        title="Negative Salary"
                        icons={tableIcons}
                        columns={columns}
                        data={negativeSalaryProcess}
                        options={{
...
export default PayrollNegativeSalaryModal;
