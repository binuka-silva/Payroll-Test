...
const EmployeeGroupModal = ({name, fetchEmployeeGroupDataFunc, ...props}) => {
    ...
    const employeeGroupFormSchema = yup.object().shape({
        ...
        <Fragment>
            ...
            <Modal show={show} onHide={handleClose} {...props}>
                <Formik
                    ...
                    validationSchema={employeeGroupFormSchema}
                                ...
                                <Modal.Body>
                                    <div className="row">
                                        ...
                                        >
                                            ...
                                            <input
                                                ...
                                                placeholder="Employee group code"
                                                name="code"
                                                value={values.code}
                                            ...
                                            <div className="invalid-feedback">
                                                Employee group code is required
                                            </div>
                                        </div>
                                        <div
                                            className={classList({
                                    ...
                                    <div className="row">
                                        ...
                                        >
                                            ...
                                            />
                                            <div className="invalid-feedback">
                                                Employee group description is required.
                                            </div>
                                        </div>
                                    </div>
                                </Modal.Body>
